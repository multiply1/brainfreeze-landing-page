...
export const FrostCard = ({ title, image, imageAlt, className }: FrostCardProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative w-full aspect-square flex flex-col items-center justify-center p-8 bg-center bg-no-repeat bg-contain",
        className
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center h-full w-full justify-between py-6 px-6">
