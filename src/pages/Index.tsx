    ...
    <div className="relative min-h-screen overflow-x-hidden font-sans text-foreground">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen pt-40 pb-20 px-4">
        ...
        >
          ...
          <button
            className="relative group flex items-center justify-center bg-center bg-no-repeat bg-contain transition-transform hover:scale-105 active:scale-95"
            style={{ 
          ...
          <button
            className="relative group flex items-center justify-center bg-center bg-no-repeat bg-contain transition-transform hover:scale-105 active:scale-95 opacity-90 hover:opacity-100"
            style={{ 
